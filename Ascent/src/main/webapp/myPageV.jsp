...
<br>
<button onclick="location='reviewList.do'" style="width: 200px;" class="hd-btn">후기 목록</button> <br>
<br>
<button onclick="location='counselList.do'" style="width: 200px;" class="hd-btn">1대1문의조회</button> <br>
<br>
