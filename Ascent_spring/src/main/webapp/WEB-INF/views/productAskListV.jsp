	...
	<table >
		...
		<c:forEach items="${list }" var="dto">
			<tr>
				...
				<td><a id="hyper" href="productAskContent?askCode=${dto.askCode }">${dto.askTitle}</a></td>						
				<td>${dto.askDate}</td>
				<td>${dto.a_ReplyCheck}</td>
			</tr>
		</c:forEach>
		<tr>
			<td align="right" colspan="5"><a id="hyper" href="productAskWriteV">글작성</a></td>
		</tr>
	</table>	
